        ...
        <form action="" method="post">
            <div class="row">
                ...
                <div class="col-sm-2" style="margin-top: 3.2%;">
                    ...
                    <button type="reset" onclick="location.href='?page=laporan-kas-masuk'" class="btn btn-light"><i class="fa fa-retweet" aria-hidden="true"></i></button>
                </div>
            </div>
        </form>
    </div>
...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="laporan-kas-masuk" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Tanggal</th>
